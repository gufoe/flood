...
(function() {
    ...
    var Net = function(a, b, mrate) {
        ...
        this.createFromStruct = (struct) => {
            ...
            for (var l = 0; l < struct.length - 1; l++) {
                ...
                for (var n = 0; n < this.network[l].length; n++) {
                    ...
                    this.outputs[l][n] = 1
                    for (var w = 0; w < syn; w++) {
                        this.network[l][n][w] = Net.genWeight(1)
                    }
                }
            }
        }
        ...
        this.createFromParents = (net0, net1, intensity) => {
            ...
            for (var i in net0.struct) {
                if (net0.struct[i] == net1.struct[i]) {
                    ...
                    throw new Exception('Nets are not compatible')
                }
            }
                ...
                for (var n = 0; n < this.network[l].length; n++) {
                    ...
                    for (var w = 0; w < this.network[l][n].length; w++) {
                        ...
                        if (Math.random() < this.mrate) {
                            this.network[l][n][w] += Net.genWeight(intensity)
                        }
                    }
                }
            }
        ...
        // Clone a net
        this.clone = (mrate) => {
            return new Net(this, this, mrate)
        }
        ...
        if (b == null) {
            ...
            this.createFromParents(a, b)
        }
    }

    // Unserialize the net
    Net.unserialize = (data) => {
        var net = new Net()
        net.outputs = []
        net.inputs = []
        net.network = util.clone(data.network)
